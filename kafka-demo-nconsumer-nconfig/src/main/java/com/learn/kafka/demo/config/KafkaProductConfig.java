...
public class KafkaProductConfig {
    ...
    public Map<String,Object> productConfigs() {
        ...
        properties.put("partitioner.class","com.learn.kafka.demo.partition.RiskPartitioner");
        //pros.put(ProducerConfig.PARTITIONER_CLASS_CONFIG, "com.learn.kafka.demo.partition.RiskPartitioner");
        return properties;
